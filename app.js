...
function getGeneralSoftwarePracticeQuestions() {
  return [
    ...
    { question: 'Git scenario: a developer wants to see changed files before committing. Which command fits?', choices: ['git status', 'git log', 'git branch', 'git remote'], answer: 0 },
    { question: 'Git concept: what is the staging area used for?', choices: ['Preparing changes for a commit', 'Listing remote branches', 'Naming a repository', 'Viewing commit history'], answer: 0 },
    { question: 'Git concept: what does git clone create?', choices: ['A local repository copy', 'A staging area snapshot', 'A commit message only', 'A branch merge only'], answer: 0 },
    { question: 'GitHub scenario: a teammate wants review before merging code. Which GitHub feature fits?', choices: ['Pull request', 'Issue', 'Fork', 'README'], answer: 0 },
    { question: 'GitHub concept: what does a repository hold?', choices: ['Project files and history', 'Pull request comments only', 'Issue labels only', 'Review approvals only'], answer: 0 },
    { question: 'GitHub concept: what does branch protection help enforce?', choices: ['Repository merge rules', 'Issue title format', 'README length', 'Fork visibility'], answer: 0 },
    { question: 'Jenkins scenario: a build failed and QA needs the error output. Where should they look?', choices: ['Console log', 'Workspace cleanup', 'Artifact archive', 'Pipeline stage name'], answer: 0 },
    { question: 'Jenkins concept: what is a build job?', choices: ['A configured automation task', 'A console log message', 'A workspace folder only', 'An artifact file only'], answer: 0 },
    { question: 'Jenkins concept: what is an artifact?', choices: ['A saved build output', 'A trigger schedule', 'A console error', 'A workspace checkout'], answer: 0 },
    { question: 'Docker scenario: a web app runs inside a container and must be reachable from the host. What is needed?', choices: ['Port mapping', 'Image tag', 'Dockerfile comment', 'Container name'], answer: 0 },
    { question: 'Docker concept: what is an image?', choices: ['A reusable template for containers', 'A running container process', 'A host port rule', 'A volume mount path'], answer: 0 },
    { question: 'Docker concept: what does a Dockerfile define?', choices: ['Image build steps', 'Container runtime logs', 'Volume data contents', 'Port traffic history'], answer: 0 },
    { question: 'ServiceNow scenario: a user cannot access email and needs service restored. Which record fits?', choices: ['Incident', 'Problem ticket', 'Change request', 'Service catalog request'], answer: 0 },
    { question: 'ServiceNow scenario: a planned firewall update needs approval before release. Which record fits?', choices: ['Change request', 'Incident', 'Problem ticket', 'Service catalog request'], answer: 0 },
    { question: 'ServiceNow concept: what does an SLA measure?', choices: ['Response or resolution target', 'Incident category only', 'Change approval group', 'Problem root cause note'], answer: 0 },
    { question: 'ServiceNow concept: what does an assignment group do?', choices: ['Routes work to a support team', 'Sets incident priority only', 'Approves every change request', 'Closes every problem ticket'], answer: 0 },
    { question: 'Deployment & DevOps scenario: a release has a severe issue and must return to the previous version. What is needed?', choices: ['Rollback plan', 'Staging environment', 'Deployment window', 'Release checklist'], answer: 0 },
    { question: 'Deployment & DevOps concept: what is release readiness?', choices: ['Confirmation that deployment conditions are met', 'Production users receiving a release', 'Rollback after a failed release', 'Staging environment naming'], answer: 0 },
    { question: 'Deployment & DevOps concept: what is a deployment window?', choices: ['Approved time for release activity', 'Production support ticket status', 'Rollback checklist owner', 'Staging test account'], answer: 0 },
